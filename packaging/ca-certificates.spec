...
%define usrcadir    %{?TZ_SYS_RO_SHARE:%TZ_SYS_RO_SHARE/}%{!?TZ_SYS_RO_SHARE:/usr/share/ca-certificates/certs/}
...
%define macro_ca_certificates %{etcdir}rpm/macro.ca-certificates
